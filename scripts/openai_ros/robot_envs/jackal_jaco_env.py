...
class JackalJacoEnv(RobotGazeboEnv):
    ...
    '''
    DESCRIPTION: TODO...
        Initializes a new JackalJacoEnv environment.
        JackalJaco doesnt use controller_manager, therefore we wont reset the 
    ...
    def _check_imu_ready(self):
        ...
        while self.imu is None and not rospy.is_shutdown():
            try:
                ...
                rospy.logerr("[jackal_jaco_env::JackalJacoEnv::_check_imu_ready] Not ready yet, retrying...")
    ...
    def _check_laser_scan_ready(self):
        ...
        while self.laser_scan is None and not rospy.is_shutdown():
            try:
                ...
                rospy.logerr("[jackal_jaco_env::JackalJacoEnv::_check_laser_scan_ready] Not ready yet, retrying...")
    ...
    def _check_camera_depth_image_raw_ready(self):
        ...
        while self.camera_depth_image_raw is None and not rospy.is_shutdown():
            try:
                ...
                rospy.logerr("[jackal_jaco_env::JackalJacoEnv::_check_camera_depth_image_raw_ready] Not ready yet, retrying...")
    ...
    def _check_camera_depth_points_ready(self):
        ...
        while self.camera_depth_points is None and not rospy.is_shutdown():
            try:
                ...
                rospy.logerr("[jackal_jaco_env::JackalJacoEnv::_check_camera_depth_points_ready] Not ready yet, retrying...")
    ...
    def _check_camera_rgb_image_raw_ready(self):
        ...
        while self.camera_rgb_image_raw is None and not rospy.is_shutdown():
            try:
                ...
                rospy.logerr("[jackal_jaco_env::JackalJacoEnv::_check_camera_rgb_image_raw_ready] not ready yet, retrying...")
    ...
    def move_base(self, linear_speed, angular_speed, epsilon=0.05, update_rate=10):
        ...
        rospy.logdebug("[jackal_jaco_env::JackalJacoEnv::move_base] cmd_vel_value: " + str(cmd_vel_value))
