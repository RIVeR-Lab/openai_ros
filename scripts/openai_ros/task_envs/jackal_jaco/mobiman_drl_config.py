...
class Config():
    ...
    def __init__(self, data_folder_path=""):        
        ...
        if self.mode == "training":
            ...
            self.reward_step_mpc = rospy.get_param('reward_step_mpc', 0.0)
            ...
            self.alpha_step_mpc = rospy.get_param('alpha_step_mpc', 0.0)
            ...
            if data_folder_path:
                ...
                training_log_data.append(["reward_step_mpc", self.reward_step_mpc])
                ...
                training_log_data.append(["alpha_step_mpc", self.alpha_step_mpc])
        ...
        print("[mobiman_drl_config::Config::__init__] reward_step_mpc: " + str(self.reward_step_mpc))
        ...
        print("[mobiman_drl_config::Config::__init__] alpha_step_mpc: " + str(self.alpha_step_mpc))
