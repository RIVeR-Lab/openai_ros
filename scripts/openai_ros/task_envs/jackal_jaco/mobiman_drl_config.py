...
class Config():
    ...
    def __init__(self, data_folder_path=""):        
        ...
        if self.mode == "training":
            ...
            self.reward_step_target2goal_threshold = rospy.get_param('reward_step_target2goal_threshold', 0.0)
            self.reward_step_target2goal_scale_beta = rospy.get_param('reward_step_target2goal_scale_beta', 0.0)
            ...
            self.reward_step_target_reached = rospy.get_param('reward_step_target_reached', 0.0)
            ...
            if data_folder_path:
                ...
                training_log_data.append(["reward_step_target2goal_threshold", self.reward_step_target2goal_threshold])
                training_log_data.append(["reward_step_target2goal_scale_beta", self.reward_step_target2goal_scale_beta])
        ...
        print("[mobiman_drl_config::Config::__init__] reward_step_target2goal_threshold: " + str(self.reward_step_target2goal_threshold))
        print("[mobiman_drl_config::Config::__init__] reward_step_target2goal_scale_beta: " + str(self.reward_step_target2goal_scale_beta))
