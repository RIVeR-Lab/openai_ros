...
class Config():
    ...
    def __init__(self, data_folder_path=""):        
        ...
        if self.mode == "training":
            ...
            self.goal_distance_ori_threshold = rospy.get_param("goal_distance_ori_threshold", 0.0)
            ...
            if data_folder_path:
                ...
                training_log_data.append(["goal_distance_ori_threshold", self.goal_distance_ori_threshold])
        ...
        print("[mobiman_drl_config::Config::__init__] goal_distance_ori_threshold: " + str(self.goal_distance_ori_threshold))
